...
public class GameResourceIT {
    ...
    private static final Long DEFAULT_P_1_POT = 1L;
    private static final Long UPDATED_P_1_POT = 2L;

    private static final Long DEFAULT_P_2_POT = 1L;
    private static final Long UPDATED_P_2_POT = 2L;

    private static final Long DEFAULT_POT = 1L;
    private static final Long UPDATED_POT = 2L;
    ...
    public static Game createEntity(EntityManager em) {
        Game game = new Game()
            ...
            .p1Pot(DEFAULT_P_1_POT)
            .p2Pot(DEFAULT_P_2_POT)
            .pot(DEFAULT_POT);
        return game;
    }
    /**
    ...
    public static Game createUpdatedEntity(EntityManager em) {
        Game game = new Game()
            ...
            .p1Pot(UPDATED_P_1_POT)
            .p2Pot(UPDATED_P_2_POT)
            .pot(UPDATED_POT);
        return game;
    }
    ...
    public void createGame() throws Exception {
        ...
        assertThat(testGame.getP1Pot()).isEqualTo(DEFAULT_P_1_POT);
        assertThat(testGame.getP2Pot()).isEqualTo(DEFAULT_P_2_POT);
        assertThat(testGame.getPot()).isEqualTo(DEFAULT_POT);
    }
    ...
    public void getAllGames() throws Exception {
        ...
        restGameMockMvc.perform(get("/api/games?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].p1Pot").value(hasItem(DEFAULT_P_1_POT.intValue())))
            .andExpect(jsonPath("$.[*].p2Pot").value(hasItem(DEFAULT_P_2_POT.intValue())))
            .andExpect(jsonPath("$.[*].pot").value(hasItem(DEFAULT_POT.intValue())));
    }
    ...
    public void getGame() throws Exception {
        ...
        restGameMockMvc.perform(get("/api/games/{id}", game.getId()))
            ...
            .andExpect(jsonPath("$.p1Pot").value(DEFAULT_P_1_POT.intValue()))
            .andExpect(jsonPath("$.p2Pot").value(DEFAULT_P_2_POT.intValue()))
            .andExpect(jsonPath("$.pot").value(DEFAULT_POT.intValue()));
    }
    ...
    public void updateGame() throws Exception {
        ...
        assertThat(testGame.getP1Pot()).isEqualTo(UPDATED_P_1_POT);
        assertThat(testGame.getP2Pot()).isEqualTo(UPDATED_P_2_POT);
        assertThat(testGame.getPot()).isEqualTo(UPDATED_POT);
    }
